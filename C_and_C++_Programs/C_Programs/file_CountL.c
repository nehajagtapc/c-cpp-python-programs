//Count THE FREQUENCY OF LETTER of "a" FROM file Neha.txt,we write there manually.
//abcdeaaaaaMarvellousab  
//  10        10       10 ashe read hoillllll......ith aap change pm kru shkto
//o/p: 8
#include<stdio.h>
#include<stdlib.h>
#include<unistd.h>
